...
export const strings = {
  en: {
    ...
    nav: {
      home: 'Home',
      blog: 'Blog',
      'free-coding-class': 'FREE Coding Class',
      about: 'About',
...
4. 💡 <b>Pick your adventure</b>: Choose a project that interests you and start\ndeveloping it. You can use any programming language you're comfortable with\nand have fun exploring new technologies.`,
    ...
    'free-class': {
      seoTitle: 'FREE Coding Class | Escuela.dev',
      title: "Join Escuela.dev<br/><span class='text-indigo-600'>Free</span> Class<br/>With Gianfranco",
      usp1: 'Online',
      ups2: '45 minutes',
      usp3: 'FREE of charge',
      ...
      cards: {
        text1:
          'Find more about the most popular programming languages today such as JavaScript, TypeScript, Python, and more',
        text2: 'Discover current trends in the tech industry',
        text3: 'Explore how coding can be useful for your current job or to start a new career',
        text4: "Find out more about Escuela.dev's courses and which one is the best fit for you",
        text5: 'Get your any questions answered',
        text6: 'See a live coding session in action',
      },
    },
    countdown: {
      days: 'days',
    ...
    testimonials: {
      ...
      quote3:
        "Gian is very sincere, and is always helpful. He understood the challenges I'm trying to solve really quick and is able to explain in a way that I'm able to understand and practice resolving challenges on individual. I always appreciate his help and am looking forward to working with him again :))",
    },
    teacher1: {
...
4. 💡 <b>Elige tu aventura</b>: Escoge un proyecto que te interese y comienza a desarrollarlo. Puedes utilizar cualquier lenguaje de programación con el que te sientas cómodo y divertirte explorando nuevas tecnologías.`,
    ...
    'free-class': {
      seoTitle: 'Clase de programación GRATIS | Escuela.dev',
      title: "Reserva una clase<br/><span class='text-indigo-600'>Gratis</span> en Escuela.dev<br/>Con Gianfranco",
      usp1: 'Online',
      ups2: '45 minutos',
      usp3: 'GRATIS',
      'what-you-ll-learn': 'Lo que aprenderás',
      buttonText: 'Reserva mi lugar',
      cards: {
        text1:
          'Encuentra más sobre los lenguajes de programación más populares hoy, como JavaScript, TypeScript, Python, y más',
        text2: 'Descubre las tendencias actuales en la industria tecnológica',
        text3: 'Explora cómo el código puede ser útil para tu trabajo actual o para comenzar un nuevo negocio',
        text4: 'Obtén más información sobre los cursos de Escuela.dev y cuál es el mejor para ti',
        text5: 'Obtén tus preguntas respondidas',
        text6: 'Ve una sesión de código en vivo',
      },
    },
    countdown: {
      days: 'días',
    ...
    testimonials: {
      ...
      quote3:
        'Gian es muy sincero y siempre está dispuesto a ayudar. Entendió muy rápido los desafíos que estoy tratando de resolver y es capaz de explicar de una manera que puedo entender y practicar para resolverlos por mi cuenta. Siempre agradezco su ayuda y espero poder trabajar con él nuevamente :))',
    },
    teacher1: {
