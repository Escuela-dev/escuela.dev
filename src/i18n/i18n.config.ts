...
export const strings = {
  en: {
    ...
    "free-class": {
      ...
      cards: {
        text1: "Find more about the most popular programming languages today such as JavaScript, TypeScript, Python, and more",
  ...
  es: {
    ...
    "free-class": {
      ...
      cards: {
        text1: "Encuentra más sobre los lenguajes de programación más populares hoy, como JavaScript, TypeScript, Python, y más",
